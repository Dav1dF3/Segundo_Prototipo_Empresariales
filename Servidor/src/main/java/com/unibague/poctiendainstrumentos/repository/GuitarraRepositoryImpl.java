...
public class GuitarraRepositoryImpl implements GuitarraRepositoryCustom
{
    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public List<Guitarra> filtrarGuitarras(FiltroInstrumentoDTO filtro) {
        StringBuilder jpql = new StringBuilder("SELECT i FROM Guitarra i WHERE 1=1 ");
        ...
        TypedQuery<Guitarra> query = entityManager.createQuery(jpql.toString(), Guitarra.class);
